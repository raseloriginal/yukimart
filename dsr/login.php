...
<head>
    ...
    <title>DSR Login - YukiMartBD</title>
...
<body class="bg-gray-50 text-gray-800 antialiased h-screen flex flex-col justify-center items-center p-4">
    ...
    <div class="w-full max-w-md bg-white rounded-2xl shadow-xl p-8 border border-gray-100">
        ...
        <h2 class="text-center text-gray-500 font-semibold mb-6 uppercase tracking-wider text-sm">Delivery Partner Portal</h2>

        <form id="login-form" class="flex flex-col gap-4">
            <input type="tel" id="phone" required placeholder="Phone Number" class="modern-input">
